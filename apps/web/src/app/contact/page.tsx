                  ...
                  <CardContent className="pt-6 text-center">
                    <div className="inline-flex items-center justify-center mb-4">
                      <div className="p-3 rounded-full bg-primary/10 group-hover:bg-primary/20 transition-colors">
                        <info.icon
                          className={`h-6 w-6 ${info.color} group-hover:scale-110 transition-transform`}
                        />
                      </div>
                    </div>
                ...
                <CardContent className="pt-6 space-y-4">
                  <div className="space-y-2 p-4 rounded-lg bg-muted/50 hover:bg-muted transition-colors">
                    ...
                    <p className="text-sm text-muted-foreground">
                      네, 기본 서비스는 무료로 이용하실 수 있습니다. 프리미엄 기능은 유료 구독이
                      필요합니다.
                    </p>
                  </div>
                  <div className="space-y-2 p-4 rounded-lg bg-muted/50 hover:bg-muted transition-colors">
                  ...
                  <div className="space-y-2 p-4 rounded-lg bg-muted/50 hover:bg-muted transition-colors">
                    ...
                    <p className="text-sm text-muted-foreground">
                      현재는 웹 서비스만 제공되며, 모바일 앱은 준비 중입니다. 웹 브라우저에서도
                      모바일 최적화되어 있습니다.
                    </p>
                  </div>
                  <div className="space-y-2 p-4 rounded-lg bg-muted/50 hover:bg-muted transition-colors">
                    ...
                    <p className="text-sm text-muted-foreground">
                      프로필 설정에서 계정 삭제를 요청하실 수 있습니다. 삭제된 계정의 데이터는
                      복구할 수 없습니다.
                    </p>
                  </div>
                </CardContent>
